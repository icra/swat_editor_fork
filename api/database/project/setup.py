...
class SetupProjectDatabase():
	...
	def create_tables():
		...
		#ICRA Adrià Riu
		base.db.create_tables([hru_parm_db.Plants_plt, hru_parm_db.Fertilizer_frt, hru_parm_db.Tillage_til, hru_parm_db.Pesticide_pst, hru_parm_db.Pathogens_pth, hru_parm_db.Pollutants_pth, hru_parm_db.Metals_mtl, hru_parm_db.Salts_slt, hru_parm_db.Urban_urb, hru_parm_db.Septic_sep, hru_parm_db.Snow_sno])
