...
class SetupDatasetsDatabase():
	...
	def create_tables():
		...
		# ICRA Adrià Riu - Modified to add pollutants table
		base.db.create_tables([hru_parm_db.Plants_plt, hru_parm_db.Fertilizer_frt, hru_parm_db.Tillage_til, hru_parm_db.Pesticide_pst, hru_parm_db.Pathogens_pth, hru_parm_db.Pollutants_pth, hru_parm_db.Urban_urb, hru_parm_db.Septic_sep, hru_parm_db.Snow_sno, soils.Soil, soils.Soil_layer, soils.Soils_lte_sol, climate.Wgn, climate.Wgn_mon])
	...
	def initialize_data(version: str = None):
		...
		file_cio = [
			...
			# ICRA Adrià Riu - Added new file type
            {'classification': 18, 'order_in_class': 11, 'default_file_name': 'pollutants.pth', 'database_table': 'pollutants_pth', 'is_core_file': False},
