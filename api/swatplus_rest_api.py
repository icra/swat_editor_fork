...
api.add_resource(auto_complete.SelectListTextApi, '/selectlist-text/<type>/<everything:project_db>')
api.add_resource(auto_complete.SelectListIndexApi, '/selectlist-index/<type>/<everything:project_db>')
...
""" ICRA Adrià Riu Setting accés to a pollutants db  """
api.add_resource(hru_parm_db.PollutantsPthListApi, '/db/pollutants/' + list_params)
api.add_resource(hru_parm_db.PollutantsPthPostApi, '/db/pollutants/' + post_params)
api.add_resource(hru_parm_db.PollutantsPthUpdateManyApi, '/db/pollutants/' + many_params)
api.add_resource(hru_parm_db.PollutantsPthApi, '/db/pollutants/' + get_params)
api.add_resource(hru_parm_db.PollutantsPthDatasetsApi, '/db/pollutants/' + datasets_get_name_params)
...
api.add_resource(decision_table.DTableDtlDatasetsBuilderApi, '/decision_table_datasets_builder/<everything:datasets_db>')
api.add_resource(decision_table.DTableDtlPostBuilderApi, '/decision_table_builder/' + post_params)
api.add_resource(decision_table.DTableDtlNameApi, '/decision_table_name/<file_name>/<name>/<everything:project_db>')
""" Decision Table """
