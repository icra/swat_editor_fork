	...
	methods: {
		putDb(data) {
			if (this.page.bulk.show)
				return this.$http.put('aquifers/initial/many/' + this.projectDbUrl, data);
			else if (this.isUpdate)
				return this.$http.put('aquifers/initial/' + this.item.id + '/' + this.projectDbUrl, data);
			else
				return this.$http.post('aquifers/initial/post/' + this.projectDbUrl, data);
		},
		async save() {
            ...
            if (!val_error) {
                try {
                    ...
                    if (this.isUpdate)
                        ...
                        this.$router.push({ name: 'AquifersInitial'});
                } catch (error) {
