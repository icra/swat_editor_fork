<template>
	<project-container :loading="page.loading" :load-error="page.error">
		<file-header input-file="pest_hru.ini" docs-path="initialization-data">
			Pesticides (HRU)
		</file-header>
			...
			<b-form @submit="save" :validated="page.validated">
				<b-table-simple responsive small table-class="edit border-bottom">
					...
					<b-tbody v-for="(item, i) in items" :key="i">
						...
						<b-tr>
							<b-td>Amount of pesticide on plant at start of simulation (kg/ha)</b-td>
						...
						<b-tr>
							<b-td>Amount of pesticide in soil at start of simulation (kg/ha)</b-td>
							<b-td v-for="(c, j) in constituents" :key="j">
...
<script>
export default {
	name: 'InitConstituentsPestHruIni',
	data() {
		return {
			apiUrl: 'constituents/pest-hru',
			relatedKey: 'pest_hrus',
			page: {
				loading: false,
				error: null,
				validated: false,
