<template>
	<project-container :loading="page.loading" :load-error="page.error">
		<file-header input-file="path_water.ini" docs-path="initialization-data">
			Pathogens (Water)
		</file-header>
			...
			<b-form @submit="save" :validated="page.validated">
				<b-table-simple responsive small table-class="edit border-bottom">
					...
					<b-tbody v-for="(item, i) in items" :key="i">
						...
						<b-tr>
							<b-td>Amount of pathogen in water at start of simulation (kg/ha)</b-td>
						...
						<b-tr>
							<b-td>Amount of pathogen in the benthic zone at start of simulation (kg/ha)</b-td>
							<b-td v-for="(c, j) in constituents" :key="j">
...
<script>
export default {
	name: 'InitConstituentsPathWaterIni',
	data() {
		return {
			apiUrl: 'constituents/path-water',
			relatedKey: 'path_waters',
			page: {
				loading: false,
				error: null,
				validated: false,
