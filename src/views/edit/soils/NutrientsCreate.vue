<template>
	<project-container :loading="page.loading" :load-error="page.error">
		<file-header input-file="nutrients.sol" docs-path="soils">
			<router-link to="/edit/soil-nutrients">Soil Nutrients</router-link>
			/ Create
		</file-header>
